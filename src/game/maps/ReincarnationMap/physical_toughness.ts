 ...
 * 肉体韧性强化系列详细数据表
 */
export const PhysicalToughnessData: Record<string, ReincarnationUpgradeDefinition> = {
    [PhysicalToughnessUpgrades.TYPE_1]: {
        id: PhysicalToughnessUpgrades.TYPE_1,
        name: '1类肉体韧性强化',
        description: '永久强化身体，每级增加 100 点最大血量',
        maxLevel: 20,
        calculateCost: (level) => level * 100,
    ...
    [PhysicalToughnessUpgrades.TYPE_4]: {
        ...
        calculateCost: (level) => level * 1250,
