...
var World = {
    ...
    drawRoad: function () {
        var findClosestRoad = function (startPos) {
            ...
            var searchX, searchY, dtmp, x = 0, y = 0, dx = 1, dy = -1;
    ...
    click: function (event) {
        ...
        centreX = map.offset().left + map.width() * World.curPos[0] / (World.RADIUS * 2), centreY = map.offset().top + map.height() * World.curPos[1] / (World.RADIUS * 2), clickX = event.pageX - centreX, clickY = event.pageY - centreY;
